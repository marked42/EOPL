...
(define (type-of exp tenv)
  (cases expression exp
    ...
    (letrec-exp (p-result-type p-name b-typed-var p-body letrec-body)
                (let ([tenv-for-letrec-body (extend-tenv* (list p-name) (list (proc-type (list (typed-var->type b-typed-var)) p-result-type)) tenv)])
                  (let ([p-body-type (type-of p-body (extend-tenv* (list (typed-var->var b-typed-var)) (list (typed-var->type b-typed-var)) tenv-for-letrec-body))])
