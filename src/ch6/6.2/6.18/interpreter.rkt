...
(require racket/lazy-require "../cps-out/expression.rkt")
(lazy-require
 ["../cps-out/environment.rkt" (
                                init-env
                                apply-env
                                extend-env
                                extend-env-rec*
                                )]
 ["../cps-out/continuation.rkt" (apply-cont end-cont)]
 ["../cps-out/value.rkt" (num-val bool-val proc-val expval->num expval->bool expval->proc)]
 ["../cps-out/parser.rkt" (scan&parse)]
 ["../cps-out/procedure.rkt" (apply-procedure procedure)])
...
(define (value-of-const-or-var-exp exp1 env)
  (cases simple-expression exp1
